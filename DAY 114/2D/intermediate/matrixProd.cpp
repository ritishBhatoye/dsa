...
vector<vector<int>> matrixProd(vector<vector<int>> &a,vector<vector<int>> &b,int row,int col)
{
...
int main()
{
    ...
    cout<<endl<<endl;
    vector<vector<int>> productAns=matrixProd(a,b,row,col);

    cout<<endl<<endl;
   
    cout<<endl<<endl;
    print2DArr(productAns,row,col);
    cout<<endl<<endl;
